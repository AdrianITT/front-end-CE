...
const items = [
...

  {
    key: 'Laboratorio',
    label: (
      <Link to="/HomeLaboratorio" rel="noopener noreferrer">
        Laboratorio
      </Link>
    ),
  },
  {
    key: 'Muestras',
    label: (
      <Link to="/Muestras" rel="noopener noreferrer">
        Muestras
      </Link>
    ),
  },
  {
    key: 'CustodiaInterna',
    label: (
      <Link to="/CustodiaInterna" rel="noopener noreferrer">
        Custodia Interna
      </Link>
    ),
  },
...
export default HeadersLaboratorio;
